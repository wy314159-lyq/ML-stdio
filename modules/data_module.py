    ...
    def apply_categorical_encoding(self):
        ...
        try:
            ...
            if method == "One-Hot Encoding":
                ...
                # Record encoding mapping for prediction module
                try:
                    from utils.prediction_utils import record_feature_encoding_for_prediction
                    record_feature_encoding_for_prediction(original_df, encoded_df, categorical_cols)
                    print(f"DEBUG: Recorded prediction encoding mapping for {len(categorical_cols)} categorical features")
                except ImportError:
                    print("Warning: Could not import prediction utilities for mapping")
            ...
            # CRITICAL FIX: Track encoding application
